  ...
  return (
    <div>
      <h2 className="text-4xl font-medium leading-tight">
        Wellcome, guys
        <span className="inline-block whitespace-nowrap rounded-[0.27rem] bg-primary-100 px-[0.65em] pb-[0.25em] pt-[0.35em] text-center align-baseline text-[0.75em] font-bold leading-none text-primary-700 dark:bg-slate-900 dark:text-primary-500">
          It's homepage bout their project
        </span>
      </h2>
